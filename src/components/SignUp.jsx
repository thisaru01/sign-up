...
function SignUp({ handleNavigate }) {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg  w-full  p-6 flex flex-col items-center m-5">
      <img src={logo1} alt="Logo1" className="w-12 h-12 mb-0" />
      <img src={logo2} alt="Logo2" className="w-40 h-30 mb-0" />

      <h1 className="text-4xl font-bold mb-2 text-center">Ready to Learn?</h1>
